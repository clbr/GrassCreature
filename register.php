...
<form action=register.php method=post id=registerform>
	...
	<tr><td>Username:</td><td><input type=text size=40 name=username onblur="reg_ajaxy()" value=""> <span id=reg_namecheck></span></td></tr>
	<tr><td>E-mail:</td><td><input type=text size=40 name=email onblur="reg_emailtest()" value=""> <span id=reg_emtest></span></td></tr>
	<tr><td>Password:</td><td><input type=password size=40 name=password1 onblur="reg_pwmatch()" value=""> <span id=pw1_pic></span></td></tr>
	<tr><td>Password again:</td><td><input type=password size=40 name=password2 onblur="reg_pwmatch()" value=""> <span id=pw2_pic></span></td></tr>
